...
ap::complex ap::operator+(const ap::complex& lhs)
{ return lhs; }

ap::complex ap::operator-(const ap::complex& lhs)
{ return ap::complex(-lhs.x, -lhs.y); }

ap::complex ap::operator+(const ap::complex& lhs, const ap::complex& rhs)
{ ap::complex r = lhs; r += rhs; return r; }

ap::complex ap::operator+(const ap::complex& lhs, const double& rhs)
{ ap::complex r = lhs; r += rhs; return r; }

ap::complex ap::operator+(const double& lhs, const ap::complex& rhs)
...
ap::complex ap::conj(const ap::complex &z)
{ return ap::complex(z.x, -z.y); }

ap::complex ap::csqr(const ap::complex &z)
